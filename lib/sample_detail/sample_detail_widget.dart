...
class SampleDetailWidget extends StatefulWidget {
  ...
  final DocumentReference detailnya;

  @override
  _SampleDetailWidgetState createState() => _SampleDetailWidgetState();
}
          ...
          children: [
            Expanded(
              child: Padding(
                ...
                child: StreamBuilder<SamplesRecord>(
                  stream: SamplesRecord.getDocument(widget.detailnya),
                  builder: (context, snapshot) {
                    ...
                    final columnSamplesRecord = snapshot.data;
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        columnSamplesRecord.sampleName,
            ...
            StreamBuilder<SamplesRecord>(
              ...
              builder: (context, snapshot) {
                ...
                final repeatableCommentSamplesRecord = snapshot.data;
                return Container(
